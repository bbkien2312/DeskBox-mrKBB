[Code]
const
  DotNetRuntimeUrl = 'https://aka.ms/dotnet/10.0/dotnet-runtime-win-arm64.exe';
  DotNetRuntimeFallbackUrl = 'https://builds.dotnet.microsoft.com/dotnet/Runtime/10.0.11/dotnet-runtime-10.0.11-win-arm64.exe';
  DotNetRuntimeInstallerName = 'dotnet-runtime-10-win-arm64.exe';
  ...
  VcRedistFallbackUrl = 'https://aka.ms/vs/17/release/vc_redist.arm64.exe';
  VcRedistInstallerName = 'vc_redist.arm64.exe';
...
begin
  ...
  if not Result then
    Log('DeskBox dependency check: Visual C++ 2015-2022 ARM64 runtime is missing.');
end;
...
begin
  ...
  try
    ...
    begin
      DependencyDownloadPage.Msg1Label.Caption := 'Downloading Visual C++ 2015-2022 Redistributable ARM64...';
      if not DownloadDependencyWithProgress(
