...
- **Phát hành Fork 7 (28/08/2026):** source `b54b895`, tag `v1.4.2.1-fork.7`; setup online 25.396.088 bytes, SHA-256 `68FE0EA7DD2C57DB0A32AB450378D859F19BFCF4B4BA0CBB14E98E43C13C5BB6`. Release còn có `DeskBox_Prerequisites_1.4.2.1_x64.exe` 165.279.618 bytes và SHA riêng. `release/stable.json` chỉ trỏ asset setup online; trước khi kết luận updater hoạt động phải tải lại raw manifest và đối chiếu build, URL, size, SHA với Release asset.
